...
//         LocalDateTime dataInicio2 = LocalDateTime.of(2024, 5, 15, 10, 30, 0);
//         LocalDateTime dataFim2 = LocalDateTime.of(2024, 5, 15, 13, 30, 0);


//         Professor p1 = new Professor("1234", "Jão", "123", "Rua Cravos", "987654", "ADS");
//         Professor p3 = new Professor();

//         Curso c1 = new Curso(1, "ADS", 250, "Capacitar alunos", "null",p1);
//         Curso c2 = new Curso(2, "ADS", 250, "Capacitar alunos2", "null", p1);


       
//         // Professor p2 = new Professor("2", null, null, null, null, null);

//         Agenda a1 = new Agenda(null, dataInicio, dataFim, "adf", "adf", "adf", "adf",p1, c1);
//         Agenda a2 = new Agenda(null, dataInicio2, dataFim2, "adf", "adf", "adf", "adf",p1, c2);

//         professorRepository.saveAll(Arrays.asList(p1));
//         cursoRepository.saveAll(Arrays.asList(c2));
       

//         if(agendaService.cadastrarAgenda(a1).){
